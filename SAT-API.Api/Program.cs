...
try
{
    ...
    app.UseSwagger();
    ConfigureSwaggerUI(app, isAzureAppService);

    app.MapGet("/", () => Results.Redirect("/swagger")).ExcludeFromDescription();
    app.MapGet("/api/info", () => new
    {
        Application = "SAT API REST",
...
static void ConfigureSwaggerUI(WebApplication app, bool isAzureAppService)
{
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "SAT API REST v1");
        c.RoutePrefix = "swagger";
        c.DocumentTitle = "SAT API REST - Documentación";
