...
try
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Microservicio.Insumos v1");
        c.RoutePrefix = "swagger";
        c.DocumentTitle = "Microservicio.Insumos - Documentación";
    ...
    {
        Application = "Microservicio.Insumos",
