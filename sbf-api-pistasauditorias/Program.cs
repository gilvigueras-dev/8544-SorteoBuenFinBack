...
try
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Microservicio.PistasAuditorias v1");
        c.RoutePrefix = "swagger";
        c.DocumentTitle = "Microservicio.PistasAuditorias - Documentación";
    ...
    {
        Application = "Microservicio.PistasAuditorias",
...
static void ConfigureSwagger(IServiceCollection services)
{
    services.AddSwaggerGen(c =>
    {
        ...
        {
            Title = "Microservicio.PistasAuditorias",
            Version = "v1",
