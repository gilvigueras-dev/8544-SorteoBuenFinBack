...
try
{
    ...
    // 1. Health Checks (cabecera inicial)
    ...
    // 4. HTTPS Redirection (importante en Azure)
    ...
    // 6. Swagger (siempre habilitado para facilidad de testing en Azure)
    app.UseSwagger();
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Microservicio.TrackEjecucion v1");
        c.RoutePrefix = "swagger";
        c.DocumentTitle = "Microservicio.TrackEjecucion - Documentación";
    ...
    {
        Application = "Microservicio.TrackEjecucion",
...
static void ConfigureSwagger(IServiceCollection services)
{
    services.AddSwaggerGen(c =>
    {
        ...
        {
            Title = "Microservicio.TrackEjecucion",
            Version = "v1",
