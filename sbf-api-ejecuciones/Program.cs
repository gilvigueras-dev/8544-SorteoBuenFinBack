...
try
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Microservicio.Ejecuciones v1");
        c.RoutePrefix = "swagger";
        c.DocumentTitle = "Microservicio.Ejecuciones - Documentación";
    ...
    {
        Application = "Microservicio.Ejecuciones",
...
{
    Log.Information("Cerrando {Cerrado}", Assembly.GetExecutingAssembly().GetName().Name);
...
static void ConfigureSwagger(IServiceCollection services)
{
    services.AddSwaggerGen(c =>
    {
        ...
        {
            Title = "Microservicio.Ejecuciones",
            Version = "v1",
